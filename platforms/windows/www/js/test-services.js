...
.factory('TestData', function () {
	...
	var test_json = {
		data: [
		{
			...
			"text":"Nell'area a nord-Est del comune di Specchia, Serra Magnone denomina il tratto di serra che più a sud prende il nome di Serra dei Peccatori e Serra dei Cianci, rispettivamente nel territorio di Specchia ed Alessano. La serra, quasi completamente coltivata ad ulivi ed organizzata in terrazzamenti su muretti a secco di contenimento, accoglie sulla cresta la Masseria del Monte, insediamento rurale con cappella dedicata a S.Antonio, risalente al XVII secolo, come riportato nell'incisione 'HOC VILLA FUNDITUS CONSTRUCTA ET DOTATA FUIT TEMPORE GUARDIA .ATUS ....BONAVENTURA ... A.D. 1604'. L'area è già fruibile ma è in programma un ulteriore intervento. Alle pendici della Serra, vicino al cimitero di Specchia, si erge la \"Collina degli inquietanti\", opera a cielo aperto di Mario Branca, Marius in arte, costituita da particolari architetture rupestri dallo stile arcaico come la cappella di pietre a secco di Nostra Signora dell'Emigrante, cui si aggiungono ceramiche e assemblaggi in ferro.",
			...
			"meta":[
				...
				{"name":"notizie_storiche","value":"Sul pendio della Serra dei Peccatori è possibile notare alcuni tratti di strada romana lastricata lungo la strada per Cardigliano. Due tratti, corrispondenti alla strada vicinale Cervi (250 m circa) e a via delle Tabacchine, sono la testimonianz"},
