	...
	L.Routing.Localization = {
		'it': {
			...
			instructions: {
				...
				'Head':
					['Vai verso {dir}', ' su {road}'],
				'Continue':
					['Continua verso {dir}', ' su {road}'],
				'SlightRight':
					['Gira Leggermente a destra', ' verso {road}'],
				'Right':
					['Gira a Destra', ' verso {road}'],
				'SharpRight':
					['Svolta a destra', ' verso {road}'],
				'TurnAround':
					['Gira intorno'],
				'SharpLeft':
					['Svolta a sinistra', ' verso {road}'],
				'Left':
					['Gira a Sinistra', ' verso {road}'],
				'SlightLeft':
					['Gira Leggermente a sinistra', ' verso {road}'],
				'WaypointReached':
					['Waypoint raggiunto'],
				'Roundabout':
					['Prendi l\'uscita {exitStr} dalla rotatoria', ' verso {road}'],
				'DestinationReached':
					['Destinazione raggiunta'],
			},
			formatOrder: function(n) {
				var i = n % 10 - 1,
				suffix = ['via', 'nd', 'strada'];
